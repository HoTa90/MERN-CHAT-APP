...
export default function SettingsPage() {
	...
	return (
		<div className="h-screen flex flex-col items-center justify-center container mx-auto px-4 pt-20 max-w-5xl">
			<div className="w-full space-y-6">
				...
				<h3 className="text-2xl font-semibold mb-3">Preview</h3>
